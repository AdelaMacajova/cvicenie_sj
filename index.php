   ...
   <?php
      include('partials/header.php'); //require namiesto include - vobec mi neukaze stranku ak mam niekde chybu, ak napisem paartials a neexistuje to tak include mi ukaze stranku bez stylov re
   ?> 
    <main>
